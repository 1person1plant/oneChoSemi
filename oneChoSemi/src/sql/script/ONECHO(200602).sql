...
SET DEFINE OFF;
Insert into ONECHO.ITEMIMAGE (ITMEIMAGE_NO,ITEM_NO,IMAGE_NO) values ('II1','I1','IMG1');
Insert into ONECHO.ITEMIMAGE (ITMEIMAGE_NO,ITEM_NO,IMAGE_NO) values ('II2','I1','IMG2');
Insert into ONECHO.ITEMIMAGE (ITMEIMAGE_NO,ITEM_NO,IMAGE_NO) values ('II3','I2','IMG3');
Insert into ONECHO.ITEMIMAGE (ITMEIMAGE_NO,ITEM_NO,IMAGE_NO) values ('II4','I2','IMG2');
