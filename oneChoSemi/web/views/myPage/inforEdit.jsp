                        ...
                        <table class="table information1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type='password' id='password1' name='password1'></td>
                                </tr>
                                <tr>
                                    <td scope="row" class="mt-2"><label>비밀번호 확인 : </label></td>
                                    <td colspan="1"><input type='password' id='password2' name='password2'></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><select id='phone' name='phone'>
                                            <option value='010'>
                                                010
                                            </option>
                                            <option value='011'>
                                        ...
                                        <input type='text' id='phone' name='phone' maxlength='4'
                                            onKeyPress='return checkNum(event)'></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type='text' id='sample3_postcode' name='addr'>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type='text' id='sample3_address' name='addr-add'></td>
                                </tr>
                                <tr>
                                    <td scope="row" class="mt-2"><label>상세 주소 : </label></td>
                                    <td colspan="2"><input type='text' id='sample3_detailAddress' name='addr-add'></td>
                                </tr>
                                <tr>
...
<img src="//t1.daumcdn.net/postcode/resource/images/close.png" id="btnFoldWrap" style="cursor:pointer;position:absolute;right:0px;top:-1px;z-index:1" onclick="foldDaumPostcode()" alt="접기 버튼">
            ...
            <script>
                $(function () {
                    ...
                    // $('#phone').on('keyup','input:text[numberOnly]',function(){
