...
<style>
            ...
            * {font-family: "basicFont";}
            ...
            #iteminfo-share {padding:0;}
            #iteminfo-cart {padding:0;}
            #iteminfo-wish {padding:0;}
            #iteminfo-icons {padding:0;}
            #iteminfo-icons-btn {padding:0;}
                            ...
                            <div class="row iteminfo-afterSale" id="iteminfo-afterSale">
                                ...
                                <div class="col-2 iteminfo-icons" id="iteminfo-icons">
                                    <span class="col iteminfo-share" id="iteminfo-share" style="justify-content:center;">
                                        <button class="btn btn-default iteminfo-icons" id="iteminfo-icons-btn" data-toggle="popover"><i class="fa fa-paperclip" style="font-size:1.5rem; color:#5b89a6;"></i></button>
                                    </span>
                                    <span class="col iteminfo-cart" id="iteminfo-cart" style="justify-content:center;">
                                        <button class="btn btn-default iteminfo-icons" id="iteminfo-icons-btn"><i class="fa fa-shopping-cart" style="font-size:1.5rem; color:gray;"></i></button>
                                    </span>
                                    <span class="col iteminfo-wish" id="iteminfo-wish" style="justify-content:center;">
                                        <button class="btn btn-default iteminfo-icons" id="iteminfo-icons-btn"><i class="fa fa-heart" style="font-size:1.5rem; color:pink;"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
