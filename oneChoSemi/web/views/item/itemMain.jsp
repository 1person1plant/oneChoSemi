...
/* item page */
            ...
            .title-col-order {padding:0rem; padding-top:1rem;}
/* item page end */
</style>
</head>
<body>
            ...
            <div class="container item-container">
                <div class="row title-row">
                    ...
                    <div class="col-sm title-col-order">
                        <ul class="float-right item-order">
                            <li><a href="#" style="text-decoration:none; color:black;">낮은가격</a></li>
                            <li><a href="#" style="text-decoration:none; color:black;">높은가격</a></li>
                            <li><a href="#" style="text-decoration:none; color:black;">제품명</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row item-row">
